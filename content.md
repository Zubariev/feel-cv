...
CVSense, is committed to protecting your personal data in accordance with the General Data Protection Regulation (GDPR). This policy outlines your rights and our responsibilities regarding data protection.
...
CVSense uses artificial intelligence technology to provide suggestions and recommendations for your CV and job applications. Here's what you need to know:

(a) AI processing is based on your explicit consent.

(b) All AI-generated content is advisory and requires your review.

(c) You can withdraw consent for AI processing at any time.
...
(d) Anonymized data may be retained for research and service improvement.
...
This GDPR Policy was last updated on 20 Dec 2025

---

AI Ethical Policy
Our commitment to responsible AI development, transparency, and ethical practices in building career advancement tools
...
CVSense's AI analyzes CVs, and application data to provide optimization suggestions. We aim for fairness, transparency, and accuracy in all our AI-powered features.
...
Important: CVSense, our AI and everything we do is not intended to get you jobs you are not qualified for. It is designed to get you only what you are ideally qualified for.
...
Users are encouraged to review AI-generated suggestions and exercise their own judgment when using AI recommendations.
...
3. Transparency
Users are informed when AI tools are being used throughout the CVSense platform and services.
...
Users acknowledge that employment decisions are made solely by employers and that the Company has no influence over such decisions regardless of the quality or nature of AI assistance provided.

4. Data Handling & Privacy
CV data and usage data are processed securely in accordance with our Privacy Policy and GDPR Policy.

AI models do not retain personally identifiable information beyond what is necessary to provide the service.

By using the Services, Users acknowledge and consent to their Content being processed by AI systems as part of the Services, including SmartMatch and Apply Assist functionality.

The Company implements appropriate technical and organisational measures to protect User data against unauthorised access, alteration, disclosure, or destruction.

5. Continuous Improvement
Models are regularly updated to improve accuracy, reduce bias, and comply with ethical standards.

Feedback from users is incorporated into AI improvement cycles to enhance the quality and effectiveness of our services.

The Company may use aggregated and anonymised data derived from User Content for service improvement, analytics, and research purposes, provided such use does not identify individual Users.
...
CVSense does not make hiring decisions; final responsibility lies with the user. Users must exercise their own judgment when using AI suggestions and recommendations.
...
This AI Ethical Policy is part of our comprehensive Terms & Conditions that govern your use of CVSense's services.
...
1. Cookie Usage and Agreement
1.1. The Company uses cookies and similar tracking technologies on the Platform in accordance with this Cookies Policy, which forms part of our Terms and Conditions.

1.2. By using the Services, the User acknowledges and agrees to the use of cookies as described in this Cookies Policy, subject to the User's consent preferences.

2. Cookie Purposes
2.1. Cookies are used for various purposes including:
...
3.1. The User may manage cookie preferences through:
...
4. Essential Cookies
4.1. Certain cookies are essential for the operation of the Platform and cannot be disabled without affecting the functionality of the Services.

5. Policy Updates
5.1. The Company may update the Cookies Policy from time to time, and continued use of the Services after such updates constitutes acceptance of the revised policy.
...
7.1. This Cookies Policy forms part of our comprehensive Terms and Conditions. For complete legal terms governing your use of CVSense, including detailed privacy provisions, data protection measures, and user obligations, please refer to our full Terms of Service.
